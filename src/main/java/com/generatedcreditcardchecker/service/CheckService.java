...
public class CheckService {
    ...
    public List<CreditCardResponse> checkCreditCardGenerated(GeneratedCreditCardRequest generatedCreditCardRequest) {
            ...
            try {
                ...
                if (response.is2xxSuccessful()) {
                    ...
                    CreditCardResponse cardResult = CreditCardResponse.builder()
                            .creditCard(card.getCardNumber() + "|" + card.getExpMounth() + "|" + card.getExpYear() + "|"
    ...
    public ResponseEntity<TokenResponse> getTokenStripe(GeneratedCreditCardInfo card) {
        ...
        String body = "card%5Bnumber%5D=" + card.getCardNumber() + "+&card%5Bexp_month%5D=" + card.getExpMounth()
